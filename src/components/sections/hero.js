...
export default function Hero() {
  return(
    <section className="mt-16 max-w-[80rem] flex flex-col  justify-center mx-auto w-full">
          <div className="flex md:flex-row flex-col-reverse justify-between mt-40 md:gap-0 gap-8 md:px-2 px-4">  
