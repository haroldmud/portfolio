...
export default function Hero() {
  return(
    <section className="mt-16 max-w-8xl flex flex-col  justify-center mx-auto w-full">
          <div className="mx-auto flex md:flex-row flex-col-reverse justify-between mt-40 md:gap-0 gap-8 md:px-2 px-4">  
            <div className="md:w-6/12 mx-auto h-fit my-auto flex flex-col gap-8">
              ...
              <div className='flex gap-2'>
                <a href='https://www.linkedin.com/in/harold-mudosa/' target='blank' className='text-3xl'><CiLinkedin /></a>
                <a href='https://github.com/haroldmud' target='blank' className='text-2xl my-auto'><LuGithub /></a>
              </div>
            </div>
